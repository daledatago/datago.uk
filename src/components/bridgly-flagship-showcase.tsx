        ...
        <div className="site-shell">
          <div className="bridgly-fabric">
            ...
            <div className="bridgly-fabric__body">
              <div className="bridgly-fabric__story">
                <div className="bridgly-fabric__visual">
                ...
                <aside className="bridgly-fabric__insight">
                  <p className="bridgly-fabric__insight-label">Operating promise</p>
                  <p className="bridgly-fabric__insight-promise">{promise}</p>
                  <div className="bridgly-fabric__insight-copy">
                    <p>{supporting.body}</p>
                  </div>
                </aside>
              </div>

              <div className="bridgly-fabric__content">
                <div className="bridgly-fabric__content-head">
                  <div>
                    <p className="bridgly-flagship__loop-label">{loopLabel}</p>
                    <h2 className="bridgly-fabric__content-title">
                      {supporting.title}
                    </h2>
                  </div>
                </div>

                <div className="bridgly-fabric__content-grid">
                  <div className="bridgly-flagship__loop bridgly-flagship__loop--integrated">
                    {loop.map((step) => (
                      <article
                  ...
                  <div className="bridgly-flagship__support-grid bridgly-flagship__support-grid--integrated">
